...
import { creatorSignupSchema, type CreatorSignupInput } from "@shared/schema";
...
export default function CreatorSignup() {
  ...
  async function onSubmit(data: CreatorSignupInput) {
    setIsLoading(true);
    try {
      const res = await apiRequest("POST", "/api/auth/creator/signup", data);
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center text-sm">
              ...
              <Link href="/creator/login" className="text-primary hover:underline" data-testid="link-login">
                Login
              </Link>
            </div>
          </CardContent>
